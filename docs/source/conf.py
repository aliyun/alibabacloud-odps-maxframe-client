...
latex_documents = [
    (master_doc, "maxframe.tex", "maxframe Documentation", "Wenjun Si", "manual"),
]
...
man_pages = [(master_doc, "maxframe", "maxframe Documentation", [author], 1)]
