...
from maxframe.dataframe.window.ewm import DataFrameEwmAgg
from maxframe.dataframe.window.expanding import DataFrameExpandingAgg
from maxframe.dataframe.window.rolling import DataFrameRollingAgg
