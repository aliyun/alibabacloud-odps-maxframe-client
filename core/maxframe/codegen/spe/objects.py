...
from maxframe.core.operator.objects import ObjectFetch


@register_op_adapter(ObjectFetch)
class TensorFetchAdapter(SPEOperatorAdapter):
    def generate_code(self, op: ObjectFetch, context: SPECodeContext) -> List[str]:
