...
from maxframe.tensor.fft.core import TensorFFTMixin, TensorHermitianFFT, validate_fft


class TensorIHFFT(TensorHermitianFFT, TensorFFTMixin):
    _op_type_ = opcodes.IHFFT
...
def ihfft(a, n=None, axis=-1, norm=None):
    ...
    * odd: ``ihfft(hfft(a, 2*len(a) - 1) == a``, within roundoff error.
    ...
    op = TensorIHFFT(n=n, axis=axis, norm=norm, dtype=np.dtype(cplx_type))
    return op(a)
