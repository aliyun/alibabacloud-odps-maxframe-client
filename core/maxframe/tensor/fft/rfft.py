...
from maxframe.tensor.fft.core import TensorFFTMixin, TensorRealFFT, validate_fft


class TensorRFFT(TensorRealFFT, TensorFFTMixin):
    _op_type_ = opcodes.RFFT
...
def rfft(a, n=None, axis=-1, norm=None):
    ...
    op = TensorRFFT(n=n, axis=axis, norm=norm, dtype=np.dtype(cplx_type))
    return op(a)
