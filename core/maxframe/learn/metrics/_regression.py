...
def r2_score(
    ...
    *,
    ...
    y_true, y_pred, sample_weight = check_consistent_length(
    ...
    res = mt.average(output_scores, weights=avg_weights)
    if execute:
        return res.execute(session=session, **(run_kwargs or dict()))
    return res
